...
<script>
    export default {
      ...
      data(){
        return {
          eyeOpen: this.toBool(localStorage.getItem('eyeState1')),
          accTabs: [
            {url: require('../images/buy.png'), txt: '买涨'},
            {url: require('../images/sale.png'), txt: '买跌'},
            {url: require('../images/account.png'), txt: '资产划转'},
            {url: require('../images/check.png'), txt: '合约账单'},
          ],
          accInfos: [],
          curBZ: '',//当前币种
          total: 0.0000,
      ...
      methods: {
        ...
        changeEyeOpen(){
          ...
          this.eyeOpen = this.toBool(localStorage.getItem('eyeState1'));
        },
        changeEyeCl(){
          localStorage.setItem('eyeState1', 'true');
          this.eyeOpen = this.toBool(localStorage.getItem('eyeState1'));
        },
        tiaoZhuan(txt){
          switch (txt) {
            ...
            case '买跌':
              ...
              return;
            case '资产划转':
              this.$router.push({path: '/assetTransfer',query: {curType: '2'}});
              return;
            case '合约账单':
              this.$router.push('conBills');
          }
        },
